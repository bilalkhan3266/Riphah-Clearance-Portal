...
/**
 * Library Department - Issue Management
 * Handles tracking of books, documents, and library resources
 */
...
exports.createIssue = async (req, res) => {
  try {
    ...
    await newIssue.save();
    res.status(201).json({ success: true, message: 'Issue created in Library', data: newIssue });
  } catch (error) {
