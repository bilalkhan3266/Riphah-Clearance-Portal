...
import { MdAdminPanelSettings, MdAssignment, MdCheckCircle, MdSend } from 'react-icons/md';
...
export default function AdminIssue() {
  ...
  const fetchIssues = async () => {
    try {
      ...
      const response = await axios.get(`/api/issues/pending/Admin`, {
  ...
  return (
    <div className="issue-container">
      <div className="issue-header">
        <h2><MdAdminPanelSettings style={{verticalAlign:'middle',marginRight:'8px'}} /> Admin - Issue Files</h2>
