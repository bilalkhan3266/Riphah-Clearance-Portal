...
export default function AdminReturn() {
  ...
  const fetchData = async () => {
    try {
      ...
      const returnsRes = await axios.get(`/api/issues/returned/Admin`, {
  ...
  return (
    <div className="return-container">
      <div className="return-header">
        <h2><MdAdminPanelSettings style={{verticalAlign:'middle',marginRight:'8px',color:'#10b981'}} /> Admin - Return Files</h2>
