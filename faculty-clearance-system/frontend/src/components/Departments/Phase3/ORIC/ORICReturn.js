...
export default function ORICReturn() {
  ...
  const fetchData = async () => {
    try {
      ...
      const returnsRes = await axios.get(`/api/issues/returned/ORIC`, {
  ...
  return (
    <div className="return-container">
      <div className="return-header">
        <h2><MdBiotech style={{verticalAlign:'middle',marginRight:'8px'}} /> ORIC - Return Files</h2>
