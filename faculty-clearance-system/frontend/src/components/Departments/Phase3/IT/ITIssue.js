...
import { MdComputer, MdAssignment, MdCheckCircle, MdSend } from 'react-icons/md';
...
export default function ITIssue() {
  ...
  const fetchIssues = async () => {
    try {
      ...
      const response = await axios.get(`/api/issues/pending/IT`, {
  ...
  return (
    <div className="issue-container">
      <div className="issue-header">
        <h2><MdComputer style={{verticalAlign:'middle',marginRight:'8px'}} /> IT - Issue Files</h2>
