...
export default function FinanceReturn() {
  ...
  const fetchReturns = async () => {
    try {
      setLoading(true);
      const response = await axios.get(`/api/issues/returned/Finance`);
  ...
  return (
    <div className="return-container">
      <div className="return-header">
        <h2><MdCheckCircle style={{verticalAlign:'middle',marginRight:'8px',color:'#10b981'}} /> Finance - Returned Items</h2>
