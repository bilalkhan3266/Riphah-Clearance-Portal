...
export default function HODReturn() {
  ...
  const fetchData = async () => {
    try {
      ...
      const returnsRes = await axios.get(`/api/issues/returned/HOD`, {
  ...
  return (
    <div className="return-container">
      <div className="return-header">
        <h2><MdSupervisorAccount style={{verticalAlign:'middle',marginRight:'8px'}} /> HOD - Return Files</h2>
