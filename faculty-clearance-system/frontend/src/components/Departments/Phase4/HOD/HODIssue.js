...
import { MdSupervisorAccount, MdAssignment, MdCheckCircle, MdSend } from 'react-icons/md';

export default function HODIssue() {
  ...
  const fetchIssues = async () => {
    try {
      ...
      const response = await axios.get(`/api/issues/pending/HOD`, {
  ...
  return (
    <div className="issue-container">
      <div className="issue-header">
        <h2><MdSupervisorAccount style={{verticalAlign:'middle',marginRight:'8px'}} /> HOD - Issue Files</h2>
