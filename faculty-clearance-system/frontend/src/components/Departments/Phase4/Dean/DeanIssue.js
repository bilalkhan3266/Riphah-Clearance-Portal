...
import { MdSchool, MdAssignment, MdCheckCircle, MdSend } from 'react-icons/md';

export default function DeanIssue() {
  ...
  const fetchIssues = async () => {
    try {
      ...
      const response = await axios.get(`/api/issues/pending/Dean`, {
  ...
  return (
    <div className="issue-container">
      <div className="issue-header">
        <h2><MdSchool style={{verticalAlign:'middle',marginRight:'8px'}} /> Dean - Issue Files</h2>
