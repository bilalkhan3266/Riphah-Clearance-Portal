...
export default function DeanReturn() {
  ...
  const fetchData = async () => {
    try {
      ...
      const returnsRes = await axios.get(`/api/issues/returned/Dean`, {
  ...
  return (
    <div className="return-container">
      <div className="return-header">
        <h2><MdSchool style={{verticalAlign:'middle',marginRight:'8px'}} /> Dean - Return Files</h2>
