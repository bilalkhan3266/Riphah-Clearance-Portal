...
import { MdSecurity, MdAssignment, MdCheckCircle, MdSend } from 'react-icons/md';

export default function WardenIssue() {
  ...
  const fetchIssues = async () => {
    try {
      ...
      const response = await axios.get(`/api/issues/pending/Warden`, {
  ...
  return (
    <div className="issue-container">
      <div className="issue-header">
        <h2><MdSecurity style={{verticalAlign:'middle',marginRight:'8px'}} /> Warden - Issue Files</h2>
