...
export default function WardenReturn() {
  ...
  const fetchData = async () => {
    try {
      ...
      const returnsRes = await axios.get(`/api/issues/returned/Warden`, {
  ...
  return (
    <div className="return-container">
      <div className="return-header">
        <h2><MdSecurity style={{verticalAlign:'middle',marginRight:'8px'}} /> Warden - Return Files</h2>
